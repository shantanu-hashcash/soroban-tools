...
# revision of the https://github.com/shantanu-hashcash/rs-stellar-xdr library used by the Rust code
RS_STELLAR_XDR_REVISION=""

# revision of https://github.com/shantanu-hashcash/stellar-xdr/ used by the Rust code
...
# revision of https://github.com/shantanu-hashcash/stellar-xdr/ used by the Go code
...
if [ "$STELLAR_XDR_REVISION_FROM_GO" != "$STELLAR_XDR_REVISION_FROM_RUST" ]; then
  echo "Go and Rust dependencies are using different revisions of https://github.com/shantanu-hashcash/stellar-xdr"
  echo
...
# Revision of https://github.com/shantanu-hashcash/rs-stellar-xdr by Core.
...
if [ "$RS_STELLAR_XDR_REVISION" != "$RS_STELLAR_XDR_REVISION_FROM_CORE" ]; then
  echo "The Core revision used in integration tests (${CORE_CONTAINER_REVISION}) uses a different revision of https://github.com/shantanu-hashcash/rs-stellar-xdr"
  echo
