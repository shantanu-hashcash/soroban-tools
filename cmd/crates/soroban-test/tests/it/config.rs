...
const NETWORK_PASSPHRASE: &str = "Local Sandbox Hcnet Network ; September 2022";
...
fn add_network_global(sandbox: &TestEnv, dir: &Path, name: &str) {
    sandbox
        ...
        .arg("Local Sandbox Hcnet Network ; September 2022")
        .arg(name)
        .assert()
        .success();
}
...
fn multiple_networks() {
    ...
    TestEnv::cmd_arr_with_pwd::<network::add::Cmd>(
        &[
            ...
            "https://127.0.0.1",
            "--network-passphrase",
            "Local Sandbox Hcnet Network ; September 2022",
            "local3",
        ],
        &sub_dir,
    )
