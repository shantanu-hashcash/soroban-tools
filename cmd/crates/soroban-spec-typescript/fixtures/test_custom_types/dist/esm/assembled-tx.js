import { Account, Address, Contract, Operation, SorobanRpc, StrKey, TimeoutInfinite, TransactionBuilder, authorizeEntry, hash, xdr, BASE_FEE, } from "hcnet-sdk";
...
export class AssembledTransaction {
    ...
    getWallet = async () => {
        return this.options.wallet ?? (await import("@hcnet/freighter-api")).default;
    };
    getPublicKey = async () => {
