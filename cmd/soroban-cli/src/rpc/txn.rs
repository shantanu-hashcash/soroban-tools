    ...
    let signed_auths = body
        ...
        .map(|raw_auth| {
            ...
            let needle = match address {
                ...
                ScAddress::Contract(Hash(c)) => {
                    ...
                    return Err(Error::MissingSignerForAddress {
                        address: hcnet_strkey::Strkey::Contract(hcnet_strkey::Contract(*c))
                            .to_string(),
                    });
                }
            };
                ...
                .find(|s| needle == s.verifying_key().as_bytes())
            {
                ...
                return Err(Error::MissingSignerForAddress {
                    address: hcnet_strkey::Strkey::PublicKeyEd25519(
                        hcnet_strkey::ed25519::PublicKey(*needle),
                    )
                    .to_string(),
                });
            };
...
mod tests {
    ...
    use hcnet_strkey::ed25519::PublicKey as Ed25519PublicKey;
    ...
    fn test_assemble_transaction_adds_the_auth_to_the_host_function() {
        ...
        assert_eq!(
            SOURCE.to_string(),
            hcnet_strkey::ed25519::PublicKey(address.0).to_string()
        );
    }
