...
- The recommended option is to compile the core source directly on your machine:
    - Clone the stellar-core repo:
        ```bash
        git clone https://github.com/shantanu-hashcash/stellar-core.git
        cd stellar-core
        ```
    - Fetch the tags and checkout the testnet release tag:
        ...
        ```
    - Follow the build steps listed in [INSTALL.md](https://github.com/shantanu-hashcash/stellar-core/blob/master/INSTALL.md) file for the instructions on building the local binary
